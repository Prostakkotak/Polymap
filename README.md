...
Настроил linux сервер для поддержки скрапинга страниц с динамичным контентом (js рендер) ~10ч <br/>
Разработал Django-структуру для написания скрапера и API ~3ч <br/>
