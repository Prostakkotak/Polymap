...
Доработал скрапер, добавил поддержку расписания сессии (v2) ~15ч <br/>
Разработал API на django REST framework ~ 6ч <br/>
Деплой Django-приложения на сервере ~8ч
...
Разработал анимированный логотип для экрана загрузки. ~3ч <br/>
Помощь в создании svg карты. ~20 часов. <br/>
Подбор набора шрифтов. ~3 часа. <br/>
Создал постер. ~3 часа.
